...
public class UserManagementController {
    ...
    public @ResponseBody RestResponse getUser(@RequestParam (value = "username") String username,
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody ResponseEntity<?> getByUserRole(@PathVariable String userRole) {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody RestResponse updateUserStatus(@RequestParam("username") String username, @RequestParam("status") String status) {
        ObjectNode objectNode = new ObjectMapper().createObjectNode();
    ...
    //@PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody RestResponse deleteUser(HttpServletRequest request) {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody RestResponse deleteAppUser(@RequestParam ("id") Long userId) {
        ObjectNode objectNode = new ObjectMapper().createObjectNode();
    ...
    @PostMapping("/add")
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody RestResponse addAppUser(@RequestBody AppUserRequest appUserRequest) {


        ObjectNode objectNode = new ObjectMapper().createObjectNode();
        objectNode.put("message", appUserService.addUser(appUserRequest));
...
//    @Transactional(rollbackFor = Exception.class)
    public @ResponseBody RestResponse updatePassword(HttpServletRequest request, @RequestParam ("password") String password) {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody ResponseEntity<List<AppUser>> findAllActiveUsers() {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody ResponseEntity<List<AppUser>> findAllDisabledUsers() {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody ResponseEntity<Page<AppUser>> findAllByPagination() {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody RestResponse getUserRoles(@PathVariable(value = "name") String username) {
        ObjectNode objectNode = new ObjectMapper().createObjectNode();
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public @ResponseBody RestResponse getUserOrderCount(@PathVariable(value = "name") String username) {
        ObjectNode objectNode = new ObjectMapper().createObjectNode();

        objectNode.put("message", "user: "+ username + " has " +
                appUserRepository.getUserOrdersCount(username) +
                " orders till present");
        return new RestResponse(
                objectNode,
                HttpStatus.OK,
